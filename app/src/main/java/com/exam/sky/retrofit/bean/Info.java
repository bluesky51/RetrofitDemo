...
public class Info {
    ...
    public static class DataBean {
        ...
        private String value320_pic;
        @SerializedName("640_pic")
        private String value640_pic;
        ...
        public String getValue320_pic() {
            return value320_pic;
        }

        public void setValue320_pic(String value320_pic) {
            this.value320_pic = value320_pic;
        }

        public String getValue640_pic() {
            return value640_pic;
        }

        public void setValue640_pic(String value640_pic) {
            this.value640_pic = value640_pic;
        }
    }
}
